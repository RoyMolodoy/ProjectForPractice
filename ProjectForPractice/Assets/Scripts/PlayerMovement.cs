...
public class PlayerMovement : MonoBehaviour
{
    ...
    public GameObject dashIconUI; // НОВЕ: Об'єкт іконки деша
    public TextMeshProUGUI dashCooldownText; // ПРОСТИЙ ТАЙМЕР
    ...
    private void Start()
    {
        ...
        // Очищаємо текст і ховаємо об'єкт на старті гри
    ...
    void Update()
    {
        ...
        // --- ЛОГІКА ПРОСТОГО ТАЙМЕРА ТА ОБ'ЄКТА ---
        ...
        {
            // Ховаємо текст і вимикаємо об'єкт, коли деш готовий
            if (dashCooldownText != null) dashCooldownText.text = "";
    ...
    IEnumerator PerformDash()
    {
        ...
        // Вмикаємо об'єкт (іконку) на початку кулдауну
